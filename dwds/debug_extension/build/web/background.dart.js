...
(function dartProgram() {
  ...
  P = {
    ...
    LinkedHashMap_LinkedHashMap$from: function(other, $K, $V) {
      ...
      other._collection$_map.forEach$1(0, H.functionTypeCheck(new P.LinkedHashMap_LinkedHashMap$from_closure(result, $K, $V), {func: 1, ret: -1, args: [H.getTypeArgumentByIndex(other, 0), H.getTypeArgumentByIndex(other, 1)]}));
      return result;
    },
  ...
  M = {
    ...
    SseClient$: function(serverUrl) {
      ...
      t4 = new M.SseClient(t2, t3, t4, N.Logger_Logger("SseClient"));
      clientId = F.Uuid$().v1$0();
      t4._eventSource = W.EventSource__factoryEventSource(serverUrl + "?sseClientId=" + clientId, P.LinkedHashMap_LinkedHashMap$_literal(["withCredentials", true], t1, null));
      t4._serverUrl = serverUrl + "?sseClientId=" + clientId;
      new P._ControllerStream(t3, [H.getTypeArgumentByIndex(t3, 0)]).listen$2$onDone(t4.get$_onOutgoingMessage(), t4.get$_onOutgoingDone());
      C.EventSource_methods.addEventListener$2(t4._eventSource, "message", t4.get$_onIncomingMessage());
      C.EventSource_methods.addEventListener$2(t4._eventSource, "control", t4.get$_onIncomingControlMessage());
      t3 = W.Event;
      W._EventStreamSubscription$(t4._eventSource, "error", H.functionTypeCheck(t2.get$addError(), {func: 1, ret: -1, args: [t3]}), false, t3);
      return t4;
    },
    ...
    main: function() {
      var t1 = P.allowInterop(new M.main_closure(), P.Function);
      chrome.browserAction.onClicked.addListener(t1);
    },
    startSseClient: function(port) {
      var $async$goto = 0,
        $async$completer = P._makeAsyncAwaitCompleter(-1),
        channel2, channel, t1;
      var $async$startSseClient = P._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
        ...
        while (true)
          switch ($async$goto) {
            case 0:
              // Function start
              channel = M.SseClient$("http://localhost:" + H.S(port) + "/test");
              t1 = channel._incomingController;
              new P._ControllerStream(t1, [H.getTypeArgumentByIndex(t1, 0)]).listen$3$cancelOnError$onError(new M.startSseClient_closure(channel), true, new M.startSseClient_closure0(channel));
              channel2 = M.SseClient$("http://localhost:" + H.S(port) + "/test");
              t1 = new W._EventStream(channel2._eventSource, "open", false, [W.Event]);
              $async$goto = 2;
              return P._asyncAwait(t1.get$first(t1), $async$startSseClient);
            case 2:
              // returning from await.
              t1 = channel2._outgoingController;
              t1.add$1(0, H.assertSubtypeOfRuntimeType("This is channel 2.", H.getTypeArgumentByIndex(t1, 0)));
              // implicit return
              return P._asyncReturn(null, $async$completer);
          }
      });
      return P._asyncStartSync($async$startSseClient, $async$completer);
    },
    ...
    startSseClient_closure: function startSseClient_closure(t0) {
      this.channel = t0;
    },
    startSseClient_closure0: function startSseClient_closure0(t0) {
      this.channel = t0;
    },
  ...
  O.Request.prototype = {
    get$encoding: function() {
      ...
      return B.requiredEncodingForCharset(_this.get$_contentType().parameters._collection$_map.$index(0, "charset"));
    },
  ...
  M.main_closure.prototype = {
    call$1: function(e) {
      ...
      t1.currentTab = null;
      t1 = P.allowInterop(new M.main__closure(P.allowInterop(new M.main__closure0(t1), {func: 1, ret: P.Null, args: [[P.List, M.Tab]]})), P.Function);
      chrome.tabs.query(query, t1);
    },
    $signature: 2
  };
  M.main__closure0.prototype = {
    call$1: function(tabs) {
      var t2, t3, t4, t5,
        currentTab = J.$index$asx(H.assertSubtype(tabs, "$isList", [M.Tab], "$asList"), 0),
        t1 = this._box_0;
      t1.currentTab = currentTab;
      t2 = {tabId: J.get$id$x(currentTab)};
      t3 = P.Function;
      t4 = P.allowInterop(new M.main___closure(), t3);
      chrome.debugger.attach(t2, "1.3", t4);
      t4 = {tabId: J.get$id$x(t1.currentTab)};
      t2 = {};
      t5 = P.allowInterop(new M.main___closure0(), t3);
      chrome.debugger.sendCommand(t4, "Debugger.enable", t2, t5);
      t1 = {tabId: J.get$id$x(t1.currentTab)};
      t5 = {expression: "$extensionPort"};
      t3 = P.allowInterop(new M.main___closure1(), t3);
      chrome.debugger.sendCommand(t1, "Runtime.evaluate", t5, t3);
    },
    $signature: 42
  };
  M.main___closure.prototype = {
    call$0: function() {
    },
    "call*": "call$0",
    $requiredArgCount: 0,
  ...
  M.main___closure0.prototype = {
    call$1: function(e) {
    },
    $signature: 2
  };
  M.main___closure1.prototype = {
    call$1: function(e) {
      M.startSseClient(J.get$value$x(J.get$result$x(H.interceptedTypeCheck(e, "$isRemoteObject"))));
    },
    $signature: 43
  };
  M.main__closure.prototype = {
    call$1: function(tabs) {
      this.callback.call$1(P.List_List$from(H.listTypeCheck(tabs), true, M.Tab));
    },
    $signature: 44
  };
  M.startSseClient_closure.prototype = {
    call$1: function(s) {
      var t1;
      H.stringTypeCheck(s);
      t1 = this.channel._outgoingController;
      t1.add$1(0, H.assertSubtypeOfRuntimeType("This is channel 1.", H.getTypeArgumentByIndex(t1, 0)));
    },
    $signature: 11
  };
  M.startSseClient_closure0.prototype = {
    call$1: function(e) {
      this.channel.close$0(0);
    },
    $signature: 2
  };
  ...
  M.Tab.prototype = {};
  M.RemoteObject.prototype = {};
  M.EvaluationResult.prototype = {};
  (function aliases() {
  ...
  (function installTearOffs() {
    ...
    _instance(P._SyncCompleter.prototype, "get$complete", 0, 0, null, ["call$1", "call$0"], ["complete$1", "complete$0"], 24, 0);
    ...
    _static_2(P, "collection___defaultEquals$closure", "_defaultEquals", 46);
    _static_1(P, "collection___defaultHashCode$closure", "_defaultHashCode", 47);
    ...
    _static_1(P, "core__identityHashCode$closure", "identityHashCode", 48);
    ...
    _instance_1_u(_ = M.SseClient.prototype, "get$_onIncomingControlMessage", "_onIncomingControlMessage$1", 13);
    _instance_1_u(_, "get$_onIncomingMessage", "_onIncomingMessage$1", 13);
  ...
  (function inheritance() {
    ...
    _inheritMany(J.JavaScriptObject, [J.PlainJavaScriptObject, J.UnknownJavaScriptObject, J.JavaScriptFunction, M.QueryInfo, M.Debuggee, M.CommandParams, M.Tab, M.RemoteObject, M.EvaluationResult]);
  ...
  var init = {mangledGlobalNames: {int: "int", double: "double", num: "num", String: "String", bool: "bool", Null: "Null", List: "List"}, mangledNames: {}, getTypeFromName: getGlobalFromName, metadata: [], types: [{func: 1, ret: P.Null}, {func: 1, ret: -1}, {func: 1, ret: P.Null, args: [,]}, {func: 1, ret: P.Null, args: [,,]}, {func: 1, ret: -1, args: [,]}, {func: 1, ret: -1, args: [P.Object], opt: [P.StackTrace]}, {func: 1, ret: P.String, args: [P.String]}, {func: 1, ret: P.Null, args: [W.ProgressEvent]}, {func: 1, ret: P.bool, args: [P.String]}, {func: 1, args: [,]}, {func: 1, ret: -1, args: [{func: 1, ret: -1}]}, {func: 1, ret: P.Null, args: [P.String]}, {func: 1, ret: P.String, args: [P.Match]}, {func: 1, ret: -1, args: [W.Event]}, {func: 1, ret: P.Null, args: [P.Symbol,,]}, {func: 1, ret: P.bool, args: [,]}, {func: 1, ret: P.Null, args: [P.String,,]}, {func: 1, ret: -1, args: [P.Object]}, {func: 1, ret: [P._Future,,], args: [,]}, {func: 1, ret: -1, args: [P.String, P.int]}, {func: 1, ret: -1, args: [P.String], opt: [,]}, {func: 1, ret: P.int, args: [P.int, P.int]}, {func: 1, ret: P.Null, args: [,], opt: [P.StackTrace]}, {func: 1, ret: P.Uint8List, args: [P.int]}, {func: 1, ret: -1, opt: [P.Object]}, {func: 1, ret: -1, args: [P.String, P.String]}, {func: 1, args: [W.Event]}, {func: 1, args: [,,]}, {func: 1, ret: P.bool, args: [P.String, P.String]}, {func: 1, ret: P.int, args: [P.String]}, {func: 1, ret: P.Null, args: [P.int,,]}, {func: 1, ret: -1, args: [[P.List, P.int]]}, {func: 1, ret: P.bool, args: [P.Object, P.Object]}, {func: 1, ret: P.Null, args: [, P.StackTrace]}, {func: 1, ret: P.bool, args: [P.Object]}, {func: 1, ret: R.MediaType}, {func: 1, ret: P.Null, args: [P.String, P.String]}, {func: 1, args: [P.String]}, {func: 1, ret: N.Logger}, {func: 1, args: [, P.String]}, {func: 1, ret: P.String, args: [P.int]}, {func: 1, ret: U.Response, args: [P.Uint8List]}, {func: 1, ret: P.Null, args: [[P.List, M.Tab]]}, {func: 1, ret: P.Null, args: [M.RemoteObject]}, {func: 1, ret: P.Null, args: [[P.List,,]]}, {func: 1, ret: P.Null, args: [{func: 1, ret: -1}]}, {func: 1, ret: P.bool, args: [,,]}, {func: 1, ret: P.int, args: [,]}, {func: 1, ret: P.int, args: [P.Object]}, {func: 1, ret: P.Uint8List, args: [,,]}], interceptorsByTag: null, leafTags: null};
  (function constants() {
...
;
    ...
    C.List_empty1 = H.setRuntimeTypeInfo(makeConstList([]), [P.Symbol]);
    C.Map_empty = new H.ConstantStringMap(0, {}, C.List_empty1, [P.Symbol, null]);
